...
class rastreio {
    ...
    start(){
        ...
        rastreio1.style.left = "50%";
        rastreio1.style.top = "50%";
        rastreio1.style.width = "400px";
        rastreio1.style.height = "70%";
        rastreio1.style.overflowY = "scroll";
        rastreio1.style.scrollbarWidth = "thin";
        rastreio1.style.scrollbarColor = "#003296 #f3f4f9";
        rastreio1.style.transform = "translate(-50%, -50%)";
        rastreio1.style.border = "solid 2px #f3f4f9";
        rastreio1.style.borderRadius = "5px";
